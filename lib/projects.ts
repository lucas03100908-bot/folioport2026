/**
 * lib/projects.ts — the project data, and nothing but.
 *
 * Copy is transcribed from Port_Ho_2026.pdf: 역할 / 도구 / 유형 / 요약 map to
 * `role` / `tools` / `type` / `blurb`, and the page's body paragraphs to
 * `summary` (with "\n\n" between them).
 *
 * Kept apart from content.ts so the types, the category table and the lookup
 * helpers stay readable — this file is long because there are seventeen
 * projects, not because anything here is complicated.
 */

import type { CategoryId, Project } from "./content";
...
export const BASE_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    context: "자율 과제 — 가상 브랜드 팝업",
    role: "경험 디자인 / 인터랙션 기획 / 리얼타임 비주얼",
    tools: "TouchDesigner",
    blurb: "방문자가 꿀벌이 되어 Hive를 움직이며 브랜드의 세계관을 체험하는 팝업 인터랙션.",
    summary:
      "버츠비 팝업스토어를 가정하여, 브랜드 경험을 확장하는 인터랙티브 미디어아트를 기획하고 제작했습니다. 환절기마다 입술이 건조해질 때 개인적으로 자주 사용하던 브랜드였기 때문에 버츠비를 선정했고, 브랜드의 핵심 이미지인 꿀벌과 Hive를 인터랙션 요소로 활용했습니다.\n\n방문자는 팝업스토어 안에서 꿀벌이 되어 Hive를 움직이며, 단순한 제품 체험을 넘어 브랜드의 자연적이고 따뜻한 세계관을 직접 경험하게 됩니다.",
    tags: ["INTERACTIVE", "REALTIME", "BRAND"],
  ...
  },
  {
    ...
    role: "리얼타임 비주얼 / 시뮬레이션",
    tools: "TouchDesigner",
    blurb: "음악의 주파수와 진폭에 유체의 흐름과 밀도가 실시간으로 반응하는 작업.",
    summary:
      "TouchDesigner로 구현한 실시간 오디오 리액티브 유체 시뮬레이션. 음악의 주파수와 진폭 데이터를 실시간으로 분석하여 유체의 흐름과 밀도가 사운드에 반응하도록 설계했습니다.\n\n청각 정보를 시각적 물성으로 변환하는 과정에 집중한 작업입니다.",
    tags: ["REALTIME", "AUDIO", "SIMULATION"],
  ...
  },
  {
    ...
    context: "World Art Expo 2025 · 코엑스 — Po-plot 작가 협업",
    role: "전시 기획 / 모션 비주얼",
  ...
  },
  {
    ...
    context: "개인 습작",
    role: "레벨 디자인 / 3D 애니메이션",
    tools: "Blender / Unreal Engine",
    blurb: "판도라의 자연환경을 모티브로 한 레벨 디자인과 애니메이션.",
    summary:
      "아바타2: 물의 길 영화 개봉 후 판도라 행성의 환경을 구현해보고 싶었습니다.\n\nBlender와 Unreal Engine을 활용하여 판도라의 자연환경을 모티브로 한 레벨 디자인과 애니메이션을 제작한 프로젝트입니다.",
    tags: ["3D", "LEVEL DESIGN", "UNREAL"],
  ...
  },
  {
    ...
    context: "개인 작업",
    role: "그래피티 아트워크 / 3D 모델링 / 모션 디자인",
    tools: "Midjourney / Blender",
    blurb: "이름의 한자 표기를 그라피티로 생성하고 3D 모션으로 확장한 작업.",
    summary:
      "나의 이름 김민호의 한문 표기를 기반으로 Midjourney에 그라피티 아트워크를 생성한 뒤, 이를 3D 모델링으로 구체화하고 Blender로 모션까지 확장한 작업입니다.\n\n텍스트 기반의 정체성을 시각적 조형 언어로 번역하고, 다시 움직이는 장면으로 발전시키는 과정을 담았습니다.",
    tags: ["MOTION", "3D", "TYPE"],
