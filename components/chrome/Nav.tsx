  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
      <div className="glass border-x-0 border-t-0">
        <div className="mx-auto flex h-[var(--nav-h)] max-w-page items-center gap-4 px-gutter">
          <a
            href="#top"
            className="hit flex shrink-0 items-center text-[13px] font-extrabold uppercase tracking-[0.3em] text-ink transition-colors hover:text-accent"
          >
            Minho
          </a>
